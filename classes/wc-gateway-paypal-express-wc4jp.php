...
class WC_Gateway_PayPal_Express_WC4JP extends WC_Payment_Gateway {
    ...
    public function __construct() {
        ...
        $this->method_title = __('PayPal Express', 'paypal-express-wc4jp');
        $this->method_description = __('・The use of the PayPal payment service, you must have PayPal business account. Opening of business account it can be done from here.<br />
<a href="https://www.paypal.com/jp/cgi-bin/webscr?cmd=_registration-run">Opening of business account</a><br /><br />
　
・Learn establishment procedure of the business account.<br />
<a href="https://www.paypal.jp/jp/contents/start/account-business/">establishment procedure of the business account</a><br /><br />
 
・Learn more about the submission of identification documents of the business account.<br />
<a href="https://www.paypal.jp/jp/contents/support/faq/faq-008/">submission of identification documents of the business account</a>　<br /><br />
 
・Contact<br />
For inquiries about the new Application and introduction (sales representative)<br />
Tel：03-6739-7135 Weekday 9:30 - 18:00（except Saturdays, Sundays and public holidays）※Call charges apply<br />
E-mail：<a href="mailto:wpp@paypal.com">wpp@paypal.com</a><br /><br />
 
If you already have a PayPal account (customer service)<br />
Tel：0120-271-888 or 03-6739-7360（Mobile phone and here from overseas ※ takes toll）<br />
9:00～20:00（Open 7days a week）', 'paypal-express-wc4jp');
		...
		$this->reference_transactions = isset($this->settings['reference_transactions']) && $this->settings['reference_transactions'] == 'yes' ? true : false;
...
//        $this->show_paypal_credit = isset($this->settings['show_paypal_credit']) ? $this->settings['show_paypal_credit'] : '';
		...
		$this->cart_border_color = isset($this->settings['cart_border_color']) ? $this->settings['cart_border_color'] : '';
		$this->template = isset($this->settings['template']) ? $this->settings['template'] : '';
 ...
 //      $this->gift_wrap_amount = isset($this->settings['gift_wrap_amount']) ? $this->settings['gift_wrap_amount'] : '';
        ...
        $this->wc4jp_skip_text = isset($this->settings['wc4jp_skip_text']) ? $this->settings['wc4jp_skip_text'] : '';
    ...
    public function get_icon() {
        ...
        $image_path = 'https://www.paypal.jp/uploadedImages/wwwpaypaljp/Supporting_Content/jp/contents/popup/logo/AM_190_65.png';
/*        if ($this->show_paypal_credit == 'yes') {
        ...
        $icon = "<img src=\"$image_path\" alt='" . __('Pay with PayPal', 'paypal-express-wc4jp') . "'/>";
    ...
    public function admin_options() {
        ...
        <h3><?php echo isset($this->method_title) ? $this->method_title : __('Settings', 'paypal-express-wc4jp'); ?></h3>
        ...
        ?>
                ...
                $('.button_upload').click(function (e) {
                    ...
                    custom_uploader = wp.media.frames.file_frame = wp.media({
                        title: '<?php _e('Choose Image', 'paypal-express-wc4jp'); ?>',
                        button: {
                            text: '<?php _e('Choose Image', 'paypal-express-wc4jp'); ?>'
                        },
                        multiple: false
                    });
    ...
    function init_form_fields() {
        ...
        $require_ssl = '';
        if (!$this->is_ssl()) {
            $require_ssl = __('This image requires an SSL host.  Please upload your image to <a target="_blank" href="http://www.sslpic.com">www.sslpic.com</a> and enter the image URL here.', 'paypal-express-wc4jp');
        }
        ...
        $this->form_fields = array(
            'enabled' => array(
                'title' => __('Enable/Disable', 'paypal-express-wc4jp'),
                'label' => __('Enable PayPal Express', 'paypal-express-wc4jp'),
                'type' => 'checkbox',
                'description' => '',
                'default' => 'no'
            ),
            'title' => array(
                'title' => __('Title', 'paypal-express-wc4jp'),
                'type' => 'text',
                'description' => __('This controls the title which the user sees during checkout.', 'paypal-express-wc4jp'),
                'default' => __('PayPal Express', 'paypal-express-wc4jp')
            ),
            'description' => array(
                'title' => __('Description', 'paypal-express-wc4jp'),
                'type' => 'textarea',
                'description' => __('This controls the description which the user sees during checkout.', 'paypal-express-wc4jp'),
                'default' => __("Pay via PayPal; you can pay with your credit card if you don't have a PayPal account", 'paypal-express-wc4jp')
            ),
			'api_credentials' => array(
				'title'       => __( 'API Credentials', 'paypal-express-wc4jp' ),
				'type'        => 'title',
			),
            'sandbox_api_username' => array(
                'title' => __('Sandbox API User Name', 'paypal-express-wc4jp'),
                'type' => 'text',
				'class'       => 'environment-field test-field',
                'default' => ''
            ),
            'sandbox_api_password' => array(
                'title' => __('Sandbox API Password', 'paypal-express-wc4jp'),
                'type' => 'password',
				'class'       => 'environment-field test-field',
                'default' => ''
            ),
            'sandbox_api_signature' => array(
                'title' => __('Sandbox API Signature', 'paypal-express-wc4jp'),
                'type' => 'password',
				'class'       => 'environment-field test-field',
                'default' => '',
				'description'     => __( 'Sandbox (test environment) for the API user name, API password, the signature information can be obtained from here.', 'paypal-express-wc4jp' ).'<a href="https://www.sandbox.paypal.com/jp/ja/cgi-bin/webscr?cmd=_get-api-signature&generic-flow=true">'.__( 'Sandbox API Setting', 'paypal-express-wc4jp' ).'</a>'
            ),
            'api_username' => array(
                'title' => __('Live API User Name', 'paypal-express-wc4jp'),
                'type' => 'text',
				'class'       => 'environment-field production-field',
                'default' => ''
            ),
            'api_password' => array(
                'title' => __('Live API Password', 'paypal-express-wc4jp'),
                'type' => 'password',
				'class'       => 'environment-field production-field',
                'default' => ''
            ),
            'api_signature' => array(
                'title' => __('Live API Signature', 'paypal-express-wc4jp'),
                'type' => 'password',
				'class'       => 'environment-field production-field',
                'default' => '',
				'description' => __( 'API user name for the production environment, API password, the signature information can be obtained from here.', 'paypal-express-wc4jp' ).'<a href="https://www.paypal.com/jp/ja/cgi-bin/webscr?cmd=_get-api-signature&generic-flow=true">'.__( 'API Setting', 'paypal-express-wc4jp' ).'</a>'
            ),
            'testmode' => array(
                'title' => __('PayPal Sandbox', 'paypal-express-wc4jp'),
                'type' => 'checkbox',
                'label' => __('Enable PayPal Sandbox', 'paypal-express-wc4jp'),
                'default' => 'yes',
                'description' => __('The sandbox is PayPal\'s test environment and is only for use with sandbox accounts created within your <a href="http://developer.paypal.com" target="_blank">PayPal developer account</a>.', 'paypal-express-wc4jp')
            ),
            'debug' => array(
                'title' => __('Debug', 'paypal-express-wc4jp'),
                'type' => 'checkbox',
                'label' => __('Enable logging <code>/wp-content/uploads/wc-logs/paypal_express-{tag}.log</code>', 'paypal-express-wc4jp'),
                'default' => 'no'
            ),
            'error_email_notify' => array(
                'title' => __('Error Email Notifications', 'paypal-express-wc4jp'),
                'type' => 'checkbox',
                'label' => __('Enable admin email notifications for errors.', 'paypal-express-wc4jp'),
                'default' => 'yes',
                'description' => __('This will send a detailed error email to the WordPress site administrator if a PayPal API error occurs.', 'paypal-express-wc4jp')
            ),
			'advanced_options' => array(
				'title'       => __( 'Advanced Options', 'paypal-express-wc4jp' ),
				'type'        => 'title',
			),

			'reference_transactions' => array(
				'title'   => __( 'Reference Transactions', 'paypal-express-wc4jp' ),
				'type'    => 'checkbox',
				'label'   => __( 'Check it if you want to use Reference Transactions. Reference Transactions is direct paypal payment system before using this site', 'paypal-express-wc4jp' ),
				'default' => 'no',
			),
            'invoice_id_prefix' => array(
                'title' => __('Invoice ID Prefix', 'paypal-express-wc4jp'),
                'type' => 'text',
                'description' => __('Add a prefix to the invoice ID sent to PayPal. This can resolve duplicate invoice problems when working with multiple websites on the same PayPal account.', 'paypal-express-wc4jp'),
				'default'     => 'WC-'
            ),
            /*
              'checkout_with_pp_button' => array(
              'title' => __( 'Checkout Button Style', 'paypal-express-wc4jp' ),
              'type' => 'checkbox',
              'label' => __( 'Use Checkout with PayPal image button', 'paypal-express-wc4jp' ),
              'default' => 'yes'
              ),
             */
            'checkout_with_pp_button_type' => array(
                'title' => __('Checkout Button Type', 'paypal-express-wc4jp'),
                'type' => 'select',
                'label' => __('Use Checkout with PayPal image button', 'paypal-express-wc4jp'),
                'class' => 'checkout_with_pp_button_type',
                'options' => array(
                    'paypalimage' => __('PayPal Image', 'paypal-express-wc4jp'),
                    'textbutton' => __('Text Button', 'paypal-express-wc4jp'),
                    'customimage' => __('Custom Image', 'paypal-express-wc4jp')
                ) // array of options for select/multiselects only
            ),
            'pp_button_type_my_custom' => array(
                'title' => __('Select Image', 'paypal-express-wc4jp'),
                'type' => 'text',
                'label' => __('Use Checkout with PayPal image button', 'paypal-express-wc4jp'),
                'class' => 'pp_button_type_my_custom',
            ),
            'pp_button_type_text_button' => array(
                'title' => __('Custom Text', 'paypal-express-wc4jp'),
                'type' => 'text',
                'class' => 'pp_button_type_text_button',
                'default' => 'Proceed to Checkout',
            ),
            /* 'hide_checkout_button' => array(
              'title' => __( 'Standard Checkout Button', 'paypal-express-wc4jp' ),
              'type' => 'checkbox',
              'label' => __( 'Hide standard checkout button on cart page', 'paypal-express-wc4jp' ),
              'default' => 'no'
              ), */
            'show_on_cart' => array(
                'title' => __('Cart Page', 'paypal-express-wc4jp'),
                'label' => __('Show Express Checkout button on shopping cart page.', 'paypal-express-wc4jp'),
                'type' => 'checkbox',
                'default' => 'yes'
            ),
            'button_position' => array(
                'title' => __('Cart Button Position', 'paypal-express-wc4jp'),
                'label' => __('Where to display PayPal Express Checkout button(s).', 'paypal-express-wc4jp'),
                'description' => __('Set where to display the PayPal Express Checkout button(s).', 'paypal-express-wc4jp'),
                'type' => 'select',
                'options' => array(
                    'top' => __('At the top, above the shopping cart details.', 'paypal-express-wc4jp'),
                    'bottom' => __('At the bottom, below the shopping cart details.', 'paypal-express-wc4jp'),
                    'both' => __('Both at the top and bottom, above and below the shopping cart details.', 'paypal-express-wc4jp')
                ),
                'default' => 'bottom'
            ),
            'show_on_checkout' => array(
                'title' => __('Checkout Page Display', 'paypal-express-wc4jp'),
                'type' => 'select',
                'options' => array(
                    'no' => __("Do not display on checkout page.", 'paypal-express-wc4jp'),
                    'top' => __('Display at the top of the checkout page.', 'paypal-express-wc4jp'),
                    'regular' => __('Display in general list of enabled gatways on checkout page.', 'paypal-express-wc4jp'),
                    'both' => __('Display both at the top and in the general list of gateways on the checkout page.')),
                'default' => 'top',
                'description' => __('Displaying the checkout button at the top of the checkout page will allow users to skip filling out the forms and can potentially increase conversion rates.','paypal-express-wc4jp')
            ),
            'show_on_product_page' => array(
                'title' => __('Product Page', 'paypal-express-wc4jp'),
                'type' => 'checkbox',
                'label' => __('Show the Express Checkout button on product detail pages.', 'paypal-express-wc4jp'),
                'default' => 'no',
                'description' => __('Allows customers to checkout using PayPal directly from a product page.', 'paypal-express-wc4jp')
            ),
            'paypal_account_optional' => array(
                'title' => __('PayPal Account Optional', 'paypal-express-wc4jp'),
                'type' => 'checkbox',
                'label' => __('Allow customers to checkout without a PayPal account using their credit card.', 'paypal-express-wc4jp'),
                'default' => 'no',
                'description' => __('PayPal Account Optional must be turned on in your PayPal account profile under Website Preferences.', 'paypal-express-wc4jp')
            ),
            'landing_page' => array(
                'title' => __('Landing Page', 'paypal-express-wc4jp'),
                'type' => 'select',
                'description' => __('Type of PayPal page to display as default. PayPal Account Optional must be checked for this option to be used.', 'paypal-express-wc4jp'),
                'options' => array('login' => __('Login', 'paypal-express-wc4jp'),
                    'billing' => __('Billing', 'paypal-express-wc4jp')),
                'default' => 'login',
            ),
            'error_display_type' => array(
                'title' => __('Error Display Type', 'paypal-express-wc4jp'),
                'type' => 'select',
                'label' => __('Display detailed or generic errors', 'paypal-express-wc4jp'),
                'class' => 'error_display_type_option',
                'options' => array(
                    'detailed' => __('Detailed', 'paypal-express-wc4jp'),
                    'generic' => __('Generic', 'paypal-express-wc4jp')
                ),
                'description' => __('Detailed displays actual errors returned from PayPal.  Generic displays general errors that do not reveal details
									and helps to prevent fraudulant activity on your site.', 'paypal-express-wc4jp')
            ),
/*            'show_paypal_credit' => array(
                'title' => __('Enable PayPal Credit', 'paypal-express-wc4jp'),
                'type' => 'checkbox',
                'label' => __('Show the PayPal Credit button next to the Express Checkout button.', 'paypal-express-wc4jp'),
                'default' => 'yes'
            ),*/
            'use_wp_locale_code' => array(
                'title' => __('Use WordPress Locale Code', 'paypal-express-wc4jp'),
                'type' => 'checkbox',
                'label' => __('Pass the WordPress Locale Code setting to PayPal in order to display localized PayPal pages to buyers.', 'paypal-express-wc4jp'),
                'default' => 'yes'
            ),
            'brand_name' => array(
                'title' => __('Brand Name', 'paypal-express-wc4jp'),
                'type' => 'text',
                'description' => __('This controls what users see as the brand / company name on PayPal review pages.', 'paypal-express-wc4jp'),
                'default' => __(get_bloginfo('name'), 'paypal-express-wc4jp')
            ),
            'checkout_logo' => array(
                'title' => __('PayPal Checkout Logo (190x90px)', 'paypal-express-wc4jp'),
                'type' => 'text',
                'description' => __('This controls what users see as the logo on PayPal review pages. ', 'paypal-express-wc4jp') . $require_ssl,
                'default' => ''
            ),
            'checkout_logo_hdrimg' => array(
                'title' => __('PayPal Checkout Banner (750x90px)', 'paypal-express-wc4jp'),
                'type' => 'text',
                'description' => __('This controls what users see as the header banner on PayPal review pages. ', 'paypal-express-wc4jp') . $require_ssl,
                'default' => ''
            ),
			'cart_border_color' => array(
				'title'       => __( 'Cart Border Color', 'paypal-express-wc4jp' ),
				'type'        => 'text',
				'desc_tip'    => __( 'This Color is PayPal cart border on the PayPal hosted checkout pages.', 'paypal-express-wc4jp' ),
				'default'     => '',
			),
			'template' => array(
				'title'       => __( 'Custom Payment Page', 'paypal-express-wc4jp' ),
				'type'        => 'text',
				'desc_tip'    => __( 'This is the name of the custom payment page to use, if you have created one.', 'paypal-express-wc4jp' ),
				'default'     => '',
			),
/*            'customer_service_number' => array(
                'title' => __('Customer Service Number', 'paypal-express-wc4jp'),
                'type' => 'text',
                'description' => __('This controls what users see for your customer service phone number on PayPal review pages.', 'paypal-express-wc4jp'),
                'default' => ''
            ),*/
/*            'gift_wrap_enabled' => array(
                'title' => __('Gift Wrap', 'paypal-express-wc4jp'),
                'type' => 'checkbox',
                'label' => __('Enables the gift wrap options for buyers.', 'paypal-express-wc4jp'),
                'default' => 'no',
                'description' => __('This will display a gift wrap option to buyers during checkout based on the following Gift Wrap settings.', 'paypal-express-wc4jp')
            ),
            'gift_message_enabled' => array(
                'title' => __('Gift Message', 'paypal-express-wc4jp'),
                'type' => 'checkbox',
                'label' => __('Enables the gift message widget on PayPal pages.', 'paypal-express-wc4jp'),
                'default' => 'no',
                'description' => __('This will allow buyers to enter a message they would like to include with the item as a gift.', 'paypal-express-wc4jp')
            ),
            'gift_receipt_enabled' => array(
                'title' => __('Gift Receipt', 'paypal-express-wc4jp'),
                'type' => 'checkbox',
                'label' => __('Enables the gift receipt widget on PayPal pages.', 'paypal-express-wc4jp'),
                'default' => 'no',
                'description' => __('This will allow buyers to choose whether or not to include a gift receipt in the order.', 'paypal-express-wc4jp')
            ),
            'gift_wrap_name' => array(
                'title' => __('Gift Wrap Name', 'paypal-express-wc4jp'),
                'type' => 'text',
                'description' => __('Label for the gift wrap option on PayPal pages, such as "Box with ribbon"', 'paypal-express-wc4jp'),
                'default' => __('Box with ribbon', 'paypal-express-wc4jp')
            ),
            'gift_wrap_amount' => array(
                'title' => __('Gift Wrap Amount', 'paypal-express-wc4jp'),
                'type' => 'text',
                'description' => __('Amount to be charged to the buyer for adding the gift wrap option.', 'paypal-express-wc4jp'),
                'default' => __('0.00', 'paypal-express-wc4jp')
            ),*/
            'wc4jp_skip_text' => array(
                'title' => __('Express Checkout Message', 'paypal-express-wc4jp'),
                'type' => 'text',
                'description' => __('This message will be displayed next to the PayPal Express Checkout button at the top of the checkout page.', 'paypal-express-wc4jp'),
                'default' => __('Skip the forms and pay faster with PayPal!', 'paypal-express-wc4jp')
            ),
            'skip_final_review' => array(
                'title' => __('Skip Final Review', 'paypal-express-wc4jp'),
                'label' => __('Enables the option to skip the final review page.', 'paypal-express-wc4jp'),
                'description' => __('By default, users will be returned from PayPal and presented with a final review page which includes shipping and tax in the order details.  Enable this option to eliminate this page in the checkout process.', 'paypal-express-wc4jp'). $skip_final_review_option_not_allowed,
                'type' => 'checkbox',
                'default' => 'no'
            ),
/*            'payment_action' => array(
                'title' => __('Payment Action', 'paypal-express-wc4jp'),
                'label' => __('Whether to process as a Sale or Authorization.', 'paypal-express-wc4jp'),
                'description' => __('Sale will capture the funds immediately when the order is placed.  Authorization will authorize the payment but will not capture the funds.  You would need to capture funds through your PayPal account when you are ready to deliver.', 'paypal-express-wc4jp'),
                'type' => 'select',
                'options' => array(
                    'Sale' => 'Sale',
            ...
            'billing_address' => array(
                'title' => __('Billing Address', 'paypal-express-wc4jp'),
                'label' => __('Set billing address in WooCommerce using the address returned by PayPal.', 'paypal-express-wc4jp'),
                'description' => __('PayPal only returns a shipping address back to the website.  Enable this option if you would like to use this address for both billing and shipping in WooCommerce.', 'paypal-express-wc4jp'),
                'type' => 'checkbox',
                'default' => 'no'
            ),
            'cancel_page' => array(
                'title' => __('Cancel Page', 'paypal-express-wc4jp'),
                'description' => __('Sets the page users will be returned to if they click the Cancel link on the PayPal checkout pages.', 'paypal-express-wc4jp'),
                'type' => 'select',
                'options' => $cancel_page,
            ),
            'send_items' => array(
                'title' => __('Send Item Details', 'paypal-express-wc4jp'),
                'label' => __('Send line item details to PayPal.', 'paypal-express-wc4jp'),
                'type' => 'checkbox',
                'description' => __('Include all line item details in the payment request to PayPal so that they can be seen from the PayPal transaction details page.', 'paypal-express-wc4jp'),
                'default' => 'yes'
            ),
        );
        $this->form_fields = apply_filters('wc4jp_ec_form_fields', $this->form_fields);
    }
	
    /**
     *  Payment Field Display checkout Page
     */
	public function payment_fields() {// add ArtisanWorkshop 2015.5.14
		echo __('PayPal is a convenient [digital wallet] on the Internet. If you register your credit card information to PayPal, settlement completion only in ID and password. Without informing the important card information in the shop, you can pay more safely. Establishment of PayPal account, is easy because only to enter the necessary information to select the PayPal in settlement method.', 'paypal-express-wc4jp');
		$billing_agreement_id = get_user_meta(get_current_user_id(), 'wc_paypal_billing_agreement_id');
		if ('yes' == $this->reference_transactions){
			if(!isset($billing_agreement_id[0])){
			?><p><input type="checkbox" name="get_billing_agreement_id" value="yes"><b><?php echo __('Check it if you want to use PayPal Account next time.', 'paypal-express-wc4jp'); ?></b></p><?php
			}else{
			?><p><input type="hidden" name="use_billing_agreement_id" value="yes"><input type="checkbox" name="change_id" value="yes"><b><?php echo __('Check it if you want to not use PayPal Account before.', 'paypal-express-wc4jp'); ?></b></p><?php
			}
		}
		if ( $this->description ) { ?>
    ...
    function checkout_message() {
        ...
        if (WC()->cart->total > 0) {
            wp_enqueue_script('wc4jp_button');
            ...
            switch ($pp_settings['checkout_with_pp_button_type']) {
                case "textbutton":
                    ...
                    echo '<a class="paypal_checkout_button paypal_checkout_button_text button alt" href="' . esc_url(add_query_arg('pp_action', 'expresscheckout', add_query_arg('wc-api', 'WC_Gateway_PayPal_Express_WC4JP', home_url('/')))) . '">' . $button_text . '</a>';
                    break;
                case "paypalimage":
                    echo '<div id="paypal_ec_button">';
                    echo '<a class="paypal_checkout_button" href="' . esc_url(add_query_arg('pp_action', 'expresscheckout', add_query_arg('wc-api', 'WC_Gateway_PayPal_Express_WC4JP', home_url('/')))) . '">';
                    echo "<img src='https://www.paypal.com/" . WC_Gateway_PayPal_Express_WC4JP::get_button_locale_code() . "/i/btn/btn_xpressCheckout.gif' border='0' alt='" . __('Pay with PayPal', 'paypal-express-wc4jp') . "'/>";
                    echo "</a>";
                    echo '</div>';
                    break;
                case "customimage":
                    ...
                    echo '<div id="paypal_ec_button">';
                    echo '<a class="paypal_checkout_button" href="' . esc_url(add_query_arg('pp_action', 'expresscheckout', add_query_arg('wc-api', 'WC_Gateway_PayPal_Express_WC4JP', home_url('/')))) . '">';
                    echo "<img src='{$button_img}' width='150' border='0' alt='" . __('Pay with PayPal', 'paypal-express-wc4jp') . "'/>";
                    echo "</a>";
                    echo '</div>';
                    break;
            }
...
/*            if ($this->show_paypal_credit == 'yes') {
                ...
                $paypal_credit_button_markup .= '<a class="paypal_checkout_button" href="' . esc_url(add_query_arg('use_paypal_credit', 'true', add_query_arg('pp_action', 'expresscheckout', add_query_arg('wc-api', 'WC_Gateway_PayPal_Express_WC4JP', home_url('/'))))) . '" >';
            ...
            if (!isset($this->settings['wc4jp_skip_text'])) {
                echo '<p class="checkoutStatus">', __('Skip the forms and pay faster with PayPal!', 'paypal-express-wc4jp'), '</p>';
            } else {
                echo '<p class="checkoutStatus">', $this->wc4jp_skip_text, '</p>';
            }
            echo '</div>';
            echo '<div class="clear"></div></div>';
            ?>
            <div class="blockUI blockOverlay wc4jpOverlay" style="display:none;z-index: 1000; border: none; margin: 0px; padding: 0px; width: 100%; height: 100%; top: 0px; left: 0px; opacity: 0.6; cursor: default; position: absolute; background: url(<?php echo WC()->plugin_url(); ?>/assets/images/ajax-loader@2x.gif) 50% 50% / 16px 16px no-repeat rgb(255, 255, 255);"></div>
            <?php
            echo '</div>';
            echo '<div style="clear:both; margin-bottom:10px;"></div>';

            //echo apply_filters( 'woocommerce_ppe_checkout_message', __( 'Have a PayPal account?', 'paypal-express-wc4jp' ) ) . '</p>';
        }
    }
	/**
        ...
        if (!empty($posted) || ( isset($_GET['pp_action']) && $_GET['pp_action'] == 'expresscheckout' )) {
            if (sizeof(WC()->cart->get_cart()) > 0) {
                ...
                if (!$review_order_page_url) {
                    $this->add_log(__('Review Order Page not found, re-create it. ', 'paypal-express-wc4jp'));
                    include_once( WC()->plugin_path() . '/includes/admin/wc-admin-functions.php' );
                    $page_id = wc_create_page(esc_sql(_x('review-order', 'page_slug', 'woocommerce')), 'woocommerce_review_order_page_id', __('Checkout &rarr; Review Order', 'paypal-express-wc4jp'), '[woocommerce_review_order]', wc_get_page_id('checkout'));
                ...
                $cancelURL = apply_filters('wc4jp_express_cancel_url', urlencode($cancelURL));
				$use_billing_agreement_id = $_POST['use_billing_agreement_id'];
				$change_id = $_POST['change_id'];
				if('yes' == $this->reference_transactions && $use_billing_agreement_id =='yes' && !$change_id){
					$resArray = $this->CallDoReferenceTransaction($paymentAmount, $posted);
					$DRT = 'yes';
				}else{
                ...
                if ($ack == "SUCCESS" || $ack == "SUCCESSWITHWARNING") {
					if (isset($DRT)){
						$result = $resArray;
						if (isset($result['PAYMENTREQUEST_0_SHIPTONAME']))
                    		WC()->customer->shiptoname = $result['PAYMENTREQUEST_0_SHIPTONAME'];
                		if (isset($result['PAYMENTREQUEST_0_SHIPTOSTREET']))
                    		WC()->customer->set_address($result['PAYMENTREQUEST_0_SHIPTOSTREET']);
                		if (isset($result['PAYMENTREQUEST_0_SHIPTOCITY']))
                    		WC()->customer->set_city($result['PAYMENTREQUEST_0_SHIPTOCITY']);
                		if (isset($result['PAYMENTREQUEST_0_SHIPTOCOUNTRYCODE']))
                   			WC()->customer->set_country($result['PAYMENTREQUEST_0_SHIPTOCOUNTRYCODE']);
                		if (isset($result['PAYMENTREQUEST_0_SHIPTOSTATE']))
                    		WC()->customer->set_state($this->get_state_code($result['PAYMENTREQUEST_0_SHIPTOCOUNTRYCODE'], $result['PAYMENTREQUEST_0_SHIPTOSTATE']));
                		if (isset($result['PAYMENTREQUEST_0_SHIPTOZIP']))
                    		WC()->customer->set_postcode($result['PAYMENTREQUEST_0_SHIPTOZIP']);
                		if (isset($result['PAYMENTREQUEST_0_SHIPTOSTATE']))
                    		WC()->customer->set_shipping_state($this->get_state_code($result['PAYMENTREQUEST_0_SHIPTOCOUNTRYCODE'], $result['PAYMENTREQUEST_0_SHIPTOSTATE']));
                		if (isset($result['PAYMENTREQUEST_0_SHIPTOZIP']))
                    		WC()->customer->set_shipping_postcode($result['PAYMENTREQUEST_0_SHIPTOZIP']);
...
//                		WC()->cart->calculate_totals();
                    	...
                    	$order->add_order_note(__('PayPal Express payment completed', 'paypal-express-wc4jp') .
                    ...
                    $this->add_log(__('SetExpressCheckout API call failed. ', 'paypal-express-wc4jp'));
                    $this->add_log(__('Detailed Error Message: ', 'paypal-express-wc4jp') . $ErrorLongMsg);
                    $this->add_log(__('Short Error Message: ', 'paypal-express-wc4jp') . $ErrorShortMsg);
                    $this->add_log(__('Error Code: ', 'paypal-express-wc4jp') . $ErrorCode);
                    $this->add_log(__('Error Severity Code: ', 'paypal-express-wc4jp') . $ErrorSeverityCode);
                    ...
                    if ($this->error_email_notify) {
                        ...
                        $message .= __('Error Code: ', 'paypal-express-wc4jp') . $ErrorCode . "\n";
                        $message .= __('Error Severity Code: ', 'paypal-express-wc4jp') . $ErrorSeverityCode . "\n";
                        $message .= __('Short Error Message: ', 'paypal-express-wc4jp') . $ErrorShortMsg . "\n";
                        $message .= __('Detailed Error Message: ', 'paypal-express-wc4jp') . $ErrorLongMsg . "\n";

                        $error_email_notify_mes = apply_filters('wc4jp_ec_error_email_notify_message', $message, $ErrorCode, $ErrorSeverityCode, $ErrorShortMsg, $ErrorLongMsg);
                        $subject = "PayPal Express Checkout Error Notification";
                        $error_email_notify_subject = apply_filters('wc4jp_ec_error_email_notify_subject', $subject);
                    ...
                    if ($this->error_display_type == 'detailed') {
                        ...
                        $error_display_type_message = sprintf(__($sec_error_notice, 'paypal-express-wc4jp'));
                    } else {
                        $error_display_type_message = sprintf(__('There was a problem paying with PayPal.  Please try another method.', 'paypal-express-wc4jp'));
                    }
                    $error_display_type_message = apply_filters('wc4jp_ec_display_type_message', $error_display_type_message, $ErrorCode, $ErrorLongMsg);
        ...
        elseif (isset($_GET['pp_action']) && $_GET['pp_action'] == 'revieworder') {
            ...
            if (!empty($result)) {
                ...
                if (isset($result['SHIPTOCOUNTRYCODE'])) {
                    ...
                    if (!array_key_exists($result['SHIPTOCOUNTRYCODE'], WC()->countries->get_allowed_countries())) {
                        wc_add_notice(sprintf(__('We do not sell in your country, please try again with another address.', 'paypal-express-wc4jp')), 'error');
                        wp_redirect(get_permalink(wc_get_page_id('cart')));
                        exit;
                    };
            ...
            if ($this->skip_final_review == 'yes' && get_option('woocommerce_enable_guest_checkout') === "yes") {
                $url = add_query_arg(array('wc-api' => 'WC_Gateway_PayPal_Express_WC4JP', 'pp_action' => 'payaction'), home_url());
                wp_redirect($url);
                exit();
            }
            ...
            if (isset($_POST['createaccount'])) {
                ...
                if (empty($_POST['username'])) {
                    wc_add_notice(__('Username is required', 'paypal-express-wc4jp'), 'error');
                } elseif (username_exists($_POST['username'])) {
                    wc_add_notice(__('This username is already registered.', 'paypal-express-wc4jp'), 'error');
                } elseif (empty($_POST['email'])) {
                    wc_add_notice(__('Please provide a valid email address.', 'paypal-express-wc4jp'), 'error');
                } elseif (empty($_POST['password']) || empty($_POST['repassword'])) {
                    wc_add_notice(__('Password is required.', 'paypal-express-wc4jp'), 'error');
                } elseif ($_POST['password'] != $_POST['repassword']) {
                    wc_add_notice(__('Passwords do not match.', 'paypal-express-wc4jp'), 'error');
                } elseif (get_user_by('email', $_POST['email']) != false) {
                    wc_add_notice(__('This email address is already registered.', 'paypal-express-wc4jp'), 'error');
                } else {
                    ...
                    try {
                        ...
                        if (!empty($_POST['email_2'])) {
                            ...
                            wc_add_notice('<strong>' . __('Anti-spam field was filled in.', 'paypal-express-wc4jp') . ':</strong> ', 'error');
                        }
                        ...
                        wc_add_notice('<strong>' . __('Error', 'paypal-express-wc4jp') . ':</strong> ' . $e->getMessage(), 'error');
                    }
            ...
            if (isset($_POST) || ($this->skip_final_review == 'yes' && get_option('woocommerce_enable_guest_checkout') === "yes")) {
                ...
                if ($this->get_session('customer_notes') != '') {
                    $order->add_order_note(__('Customer Notes: ', 'paypal-express-wc4jp') . $this->get_session('customer_notes'));
                }
                ...
                if ($result['ACK'] == 'Success' || $result['ACK'] == 'SuccessWithWarning') {
					...
					if(isset($result['BILLINGAGREEMENTID'])){
						update_user_meta( $order->customer_user, 'wc_paypal_billing_agreement_id', $result['BILLINGAGREEMENTID'] );
					}
                    ...
                    $payerstatus_note = __('Payer Status: ', 'paypal-express-wc4jp');
                    $payerstatus_note .= ucfirst($REVIEW_RESULT['PAYERSTATUS']);
                    $order->add_order_note($payerstatus_note);
                    $addressstatus_note = __('Address Status: ', 'paypal-express-wc4jp');
					...
					{
						$admin_email = get_option("admin_email");
						$message .= __( "DoExpressCheckoutPayment API call failed." , "paypal-express-wc4jp" )."\n\n";
						$message .= __( 'Error Code: ' ,'paypal-express-wc4jp' ) . $ErrorCode."\n";
						$message .= __( 'Error Severity Code: ' , 'paypal-express-wc4jp' ) . $ErrorSeverityCode."\n";
						$message .= __( 'Short Error Message: ' , 'paypal-express-wc4jp' ) . $ErrorShortMsg ."\n";
						$message .= __( 'Detailed Error Message: ' , 'paypal-express-wc4jp') . $ErrorLongMsg ."\n";
                        $message .= __( 'Order ID: ' , 'paypal-express-wc4jp').$order_id ."\n";
                        $message .= __( 'Customer Name: ' , 'paypal-express-wc4jp').$this->get_session('shiptoname')."\n";
                        $message .= __( 'Customer Email: ' , 'paypal-express-wc4jp').$this->get_session('payeremail')."\n";
    ...
    function CallSetExpressCheckout($paymentAmount, $returnURL, $cancelURL, $usePayPalCredit = false, $posted) {
         ...
         */
        if (sizeof(WC()->cart->get_cart()) == 0) {
            $ms = sprintf(__('Sorry, your session has expired. <a href=%s>Return to homepage &rarr;</a>', 'paypal-express-wc4jp'), '"' . home_url() . '"');
            $set_ec_message = apply_filters('wc4jp_set_ec_message', $ms);
         ...
         */
        if (!class_exists('Wc4jp_PayPal')) {
            require_once( 'lib/wc4jp/paypal-php-library/includes/paypal.class.php' );
        }
        ...
        $PayPal = new Wc4jp_PayPal($PayPalConfig);
         ...
         *
         * https://github.com/artisanworkshop/paypal-woocommerce/issues/142
         */
...
*/
		...
		if('yes' == $this->reference_transactions && get_post('get_billing_agreement_id') == 'yes'){
			$Item['l_billingtype'] ='MerchantInitiatedBillingSingleAgreement';
		}
    ...
    function CallGetShippingDetails($token) {
        ...
        if (sizeof(WC()->cart->get_cart()) == 0) {
            $ms = sprintf(__('Sorry, your session has expired. <a href=%s>Return to homepage &rarr;</a>', 'paypal-express-wc4jp'), '"' . home_url() . '"');
            $ec_cgsd_message = apply_filters('wc4jp_get_shipping_ec_message', $ms);
     ...
     * @cancelURL (string) URL for PayPal to send the buyer to if they cancel the payment.
     */
    function CallDoReferenceTransaction($paymentAmount, $posted) {
        /*
         * Display message to user if session has expired.
         */
        if (sizeof(WC()->cart->get_cart()) == 0) {
         ...
         */
		 $billing_agreement_id = get_user_meta(get_current_user_id(), 'wc_paypal_billing_agreement_id');
        $DRTFields = array(
            'maxamt' => WC()->cart->total*2, // The expected maximum total amount the order will be, including S&H and sales tax.
            'referenceid' => $billing_agreement_id[0],        // (Required) A valid transaction ID from a previous purchase, such as a credit card charge using a valid billing agreement ID.
        ...
        if (!empty($posted) && WC()->cart->needs_shipping()) {
            if (@$posted['ship_to_different_address']) {
                ...
                $Payment['shiptocountrycode'] = @$posted['shipping_country'];
                $Payment['shiptophonenum'] = @$posted['shipping_phone'];
                $ShippingAddress['shiptoname'] = $posted['shipping_first_name'] . ' ' . $posted['shipping_last_name'];
                $ShippingAddress['shiptostreet'] = $posted['shipping_address_1'];
                $ShippingAddress['shiptostreet2'] = @$posted['shipping_address_2'];
                $ShippingAddress['shiptocity'] = @$posted['shipping_city'];
                $ShippingAddress['shiptostate'] = @$posted['shipping_state'];
                $ShippingAddress['shiptozip'] = @$posted['shipping_postcode'];
                $ShippingAddress['shiptocountrycode'] = @$posted['shipping_country'];
                $ShippingAddress['shiptophonenum'] = @$posted['shipping_phone'];
            } else {
                $Payment['shiptoname'] = $posted['billing_first_name'] . ' ' . $posted['billing_last_name'];
                $Payment['shiptostreet'] = $posted['billing_address_1'];
                $Payment['shiptostreet2'] = @$posted['billing_address_2'];
                ...
                $Payment['shiptocountrycode'] = @$posted['billing_country'];
                $Payment['shiptophonenum'] = @$posted['billing_phone'];
                $ShippingAddress['shiptoname'] = $posted['billing_first_name'] . ' ' . $posted['billing_last_name'];
                $ShippingAddress['shiptostreet'] = $posted['billing_address_1'];
                $ShippingAddress['shiptostreet2'] = @$posted['billing_address_2'];
                $ShippingAddress['shiptocity'] = @$posted['billing_city'];
                $ShippingAddress['shiptostate'] = @$posted['billing_state'];
                $ShippingAddress['shiptozip'] = @$posted['billing_postcode'];
                $ShippingAddress['shiptocountrycode'] = @$posted['billing_country'];
                $ShippingAddress['shiptophonenum'] = @$posted['billing_phone'];
            }
        }
        ...
        if (WC()->cart->get_cart_discount_total() > 0) {
            foreach (WC()->cart->get_coupons('cart') as $code => $coupon) {
                $Item = array(
                    'name' => __('Cart Discount', 'paypal-express-wc4jp'),
                    'number' => $code,
                    'qty' => '1',
                    'amt' => '-' . number_format(WC()->cart->coupon_discount_amounts[$code], 2, '.', '')
                );
        ...
        if (!$this->is_wc_version_greater_2_3()) {
            if (WC()->cart->get_order_discount_total() > 0) {
                foreach (WC()->cart->get_coupons('order') as $code => $coupon) {
                    $Item = array(
                        'name' => __('Order Discount', 'paypal-express-wc4jp'),
                        'number' => $code,
                        'qty' => '1',
                        'amt' => '-' . number_format(WC()->cart->coupon_discount_amounts[$code], 2, '.', '')
                    );
...
//        }
    ...
    function ConfirmPayment($FinalPaymentAmt) {
        ...
        if (sizeof(WC()->cart->get_cart()) == 0) {
            $ms = sprintf(__('Sorry, your session has expired. <a href=%s>Return to homepage &rarr;</a>', 'paypal-express-wc4jp'), '"' . home_url() . '"');
            $ec_confirm_message = apply_filters('wc4jp_ec_confirm_message', $ms);
                    ...
                    echo '<script type="text/javascript">
                                jQuery(document).ready(function(){
                                    if (jQuery(".checkout-button").is("input")) {
                                        jQuery(".checkout-button").val("' . __('Pay with Credit Card', 'paypal-express-wc4jp') . '");
                                    } else jQuery(".checkout-button").html("<span>' . __('Pay with Credit Card', 'paypal-express-wc4jp') . '</span>");
                                });
                              </script>';
     ...
     */
    static function woocommerce_paypal_express_checkout_button_wc4jp() {
        global $pp_settings, $pp_pro, $pp_payflow;
        $payment_gateways = WC()->payment_gateways->get_available_payment_gateways();
        // Pay with Credit Card
        unset($payment_gateways['paypal_pro']);
        ...
        if (@$pp_settings['enabled'] == 'yes' && (empty($pp_settings['show_on_cart']) || $pp_settings['show_on_cart'] == 'yes') && 0 < WC()->cart->total) {
            ...
            switch ($pp_settings['checkout_with_pp_button_type']) {
                case "textbutton":
                    ...
                    echo '<a class="paypal_checkout_button button alt" href="' . esc_url(add_query_arg('pp_action', 'expresscheckout', add_query_arg('wc-api', 'WC_Gateway_PayPal_Express_WC4JP', home_url('/')))) . '">' . $button_text . '</a>';
                    break;
                case "paypalimage":
                    echo '<div id="paypal_ec_button">';
                    echo '<a class="paypal_checkout_button" href="' . esc_url(add_query_arg('pp_action', 'expresscheckout', add_query_arg('wc-api', 'WC_Gateway_PayPal_Express_WC4JP', home_url('/')))) . '">';
    ...
    static function get_button_locale_code() {
        $locale_code = defined("WPLANG") && get_locale() != '' ? get_locale() : 'ja_JP';
        switch ($locale_code) {
            case "de_DE": $locale_code = "de_DE/DE";
                break;
			case "JP": $locale_code = "ja_JP";
				break;
        }
        return $locale_code;
    }
    ...
    public function process_refund($order_id, $amount = null, $reason = '') {
        ...
        if ($PayPal->APICallSuccessful($PayPalResult['ACK'])) {
            ...
            $ec_message = apply_filters('wc4jp_ec_refund_message', $PayPalResult['L_LONGMESSAGE0'], $PayPalResult['L_ERRORCODE0'], $PayPalResult);
    ...
    function top_cart_button() {
        if (!empty($this->settings['button_position']) && ($this->settings['button_position'] == 'top' || $this->settings['button_position'] == 'both')) {
            $this->woocommerce_paypal_express_checkout_button_wc4jp();
        }
    }

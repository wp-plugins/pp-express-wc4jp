...
<form class="wc4jp_checkout" method="POST" action="<?php echo add_query_arg( 'pp_action', 'payaction', add_query_arg( 'wc-api', 'WC_Gateway_PayPal_Express_WC4JP', home_url( '/' ) ) );?>">
...
$cancel_url = apply_filters( 'wc4jp_review_order_cance_url', $cancel_url );
echo '<div class="clear"></div>';
echo '<p><a class="button wc4jp_cancel" href="' . $cancel_url . '">'.__('Cancel order', 'paypal-express-wc4jp').'</a> ';
echo '<input type="submit" onclick="jQuery(this).attr(\'disabled\', \'disabled\').val(\'Processing\'); jQuery(this).parents(\'form\').submit(); return false;" class="button" value="' . __( 'Place Order','paypal-express-wc4jp') . '" /></p>';
    ?>
